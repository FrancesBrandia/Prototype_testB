const dropdownCode = `
    <code-block class="html javascript">
        <div class="code html">&lt;div id="unique-dropdown-id" class="dropdown"&gt;
...
class DropdownCode extends HTMLElement {
    constructor() {
        super();
        this.innerHTML = dropdownCode;
        this.setAttribute('class', 'code-section');
    }
}

customElements.define('dropdown-code', DropdownCode);